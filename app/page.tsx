    ...
    to-[#1ABC9C]  border-8 border-[#2C3E50] ">
      <div className="">
        ...
        <section
          ...
          <section className=" grid lg:flex bg-[rgb(81,95,109)] justify-center items-end md:items-center m-1 mt-20 md:w-1/2 lg:mt-0 lg:w-8/12 rounded-2xl shadow-xl">
            <section className="flex flex-col justify-end md:justify-start items-center h-full md:w-full mt-20 md:mt-0  iphone-se-margin    float-left">
              <Image
